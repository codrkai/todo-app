                          ...
                          {(draggableProvided) => (
                            ...
                            >
                              <li key={item.id} className="w-full border-2 rounded-xl mt-2 hover:border-blue-300">
                                ...
                                <button id={index} onClick={() => handleDelete(index, item.id)} className="float-right w-7 h-7 m-2.5 rounded-2xl bg-red-700 text-gray-200 shadow-md hover:bg-red-500 hover:scale-105">x</button>
